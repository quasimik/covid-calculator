interface RiskParameters {
    ...
    preexisting_conditions: Array<PreexistingCondition>;
    // location_past_week: LocationCovidData;
    state_covid_data: StateCovidData;
    covid_test_results: Array<CovidTestResult>;
    symptoms: Array<Symptom>;
    close_contacts: Array<CloseContact>;
}
...
interface Symptom extends DataSource {
    name: string;
    comorbidity: NumberOrLimit;
}
...
export type { RiskParameters, HealthProfile, PreexistingCondition, CovidTest, CovidTestResult, Symptom, CloseContact };
export { NumberLimit, BirthSex, State, StateCovidData, CovidTestType, CovidTestOutcome };
export { StatewiseCovidData, PreexistingConditions, CovidTests, Symptoms };
